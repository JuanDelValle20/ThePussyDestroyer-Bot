...
const handler = async (m, { conn, args }) => {
   const res = await fetch('https://api.github.com/repos/JuanDelValle20/ThePussyDestroyer-Bot');
   const json = await res.json();
   let txt = `           *乂  B O T  -  S C R I P T  乂*\n\n`;
      txt += `◦  *Nombre:* ${json?.name || 'ThePussyDestroyer-Bot'}\n`;
      ...
      txt += `◦  *Url:* ${json?.html_url || 'https://github.com/JuanDelValle20/ThePussyDestroyer-Bot'}\n\n`;
